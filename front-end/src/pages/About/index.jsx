...
export default function About() {
  return (
    <div class='About'>
      <div class='title'>
        <img src="https://see.fontimg.com/api/renderfont4/4a4x/eyJyIjoiZnMiLCJoIjo1MCwidyI6MjAwMCwiZnMiOjI1LCJmZ2MiOiIjOTYxQjFCIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/QUJPVVQgSU5EVUxHRU5DRS4/straighttohell-bb.png" alt="Ancient fonts"></img>
      </div>
      ...
      <div class='title'>
        <img src="https://see.fontimg.com/api/renderfont4/4a4x/eyJyIjoiZnMiLCJoIjo1MCwidyI6MjAwMCwiZnMiOjI1LCJmZ2MiOiIjOTYxQjFCIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/SU5EVUxHRU5DRS4gVEVDSCBTVEFDSw/straighttohell-bb.png" alt="Ancient fonts"></img>
      </div>
